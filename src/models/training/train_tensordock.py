...
import psutil  # Add this import at the top of the file with other imports
...
class TrainingMonitorCallback(TrainerCallback):
    ...
    def on_train_begin(self, args, state, control, **kwargs):
        ...
        log_memory_usage()  # Log initial memory usage
    ...
    def on_train_end(self, args, state, control, **kwargs):
        ...
        summary = {
            ...
            'total_ram': self._get_total_ram()  # GB
        }
